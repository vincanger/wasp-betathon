...
import logo from './saasathon-logo.png';

const MainPage = () => {
  const [registerOrSubmit, setRegisterOrSubmit] = useState(false);

  const startDateString = '2023-10-22T00:00:00';
  const endDateString = '2023-10-28T23:59:00';
    ...
    <div>
      ...
      <main>
        ...
        <div className='flex justify-center mb-12 p-5'>
          <img src={logo} className='md:w-[75%] center' />
        </div>
